...
주석 XBRL zip           map_row (id-first)                  재무제표 행 · SCE 행 · 주석 fact
...
원본 항목 전량 = 적재 + 사유 있는 제외 + 미설명(1건이라도 있으면 미통과)
  ...
  주석        XBRL fact 전량            제외 사유: 본표 중복(무차원 흡수) · 메타(표지·감사인·연락처)
```
...
준비완료 12개 회사연도 실측: 재무제표 4,382행 전량 설명(적재 4,314 + 표 재분류 68 · **미설명 0**), 주석 12곳 전량 설명(**미설명 0**). 아스트 2020은 원본 387행 = 적재 359 + 표 재분류 28, 주석 953건 = 적재 137 + 메타 207 + 본표 중복 609.
