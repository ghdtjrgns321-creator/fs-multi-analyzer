...
이 경로에는 **연도·규모 제약**이 있다. 주석 XBRL 태깅은 2023년부터 자산 규모 기준으로 단계 적용됐으므로, 2022년 이하 회사연도에는 주석 fact가 사실상 존재하지 않고(전 코퍼스 4,614 회사연도 실측) 2023년 이후에도 적용 대상은 일부다. 본문 III장 경로를 편입한 근거가 이것이다.
