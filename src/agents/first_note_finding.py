...
async def run_first_note_finding(
    corp_code: str = "00126380",
    year: int = 2025,
) -> dict[str, object]:
    return await run_account_finding("매출채권", year, corp_code=corp_code)
...
def main() -> None:
    ...
    result = asyncio.run(run_first_note_finding(args.corp_code, args.year))
