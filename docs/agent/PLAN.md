...
| 항목                  | 내용                                                      | 비고                     |
|-----------------------|-----------------------------------------------------------|--------------------------|
| 업종 벤치마크          | 업종 내 다수 회사 수집·정규화해 "업종 대비 비정상" 판단     | L1 정규화 부담 N배 — materiality baseline 추상화로 대비 |
| 소수 피어 수동 지정    | 업종 풀 대신 2~3개사 수동 지정 비교                         | 업종 벤치마크의 중간 단계 |
