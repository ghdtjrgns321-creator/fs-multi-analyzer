...
| [user/UI.md](user/UI.md)                               | 화면 구성·사용자 흐름·UX 원칙 (일부 구현, 일부 설계안)                                              |
...
| [user/VERIFICATION.md](user/VERIFICATION.md)           | 엔진 검증 — 121사 전수 홀리스틱 리뷰 + 교차검증으로 계산 정확성을 세운 방법 (+ 대주산업 전과정 E2E) |
...
| [agent/P1_AUDIT_HARNESS.md](agent/P1_AUDIT_HARNESS.md)                         | Phase1 정규화 감사 하니스 — 본질적 한계·회사 전수·판정 매트릭스·전용 에이전트(user→agent 이관) | 하니스 변경 시           |
| [agent/ONBOARDING_LLM_PLAN.md](agent/ONBOARDING_LLM_PLAN.md)                   | 온보딩 LLM 개선 실험 로그 — 별칭 적중·배치·힌트·비용(user→agent 이관)                          | 실험 진행 시             |
