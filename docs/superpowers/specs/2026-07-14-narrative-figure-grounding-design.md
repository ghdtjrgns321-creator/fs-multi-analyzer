...
> 반박 "전체 자산 583.1억 감소"를 환각으로 의심. 검출감사(A) 3종 실패 → 예방(B) 채택.
>
> **정정(2026-07-20):** 발단의 "583.1억 환각(실제 298.8억)" 전제는 오판이었다. as-filed series
> (2019 5,787.6억 → 2020 5,204.4억) 기준 583.1은 grounded이고, 298.8은 재작성 비교치라 as-filed
> 도표에 없다. 정당화 사례가 오판이었던 것이 곧 파이프라인 배선 보류의 근거다. 아래 설계 상세의
> "583.1 미포함/흡수" 서술은 이 오판 전제 하에 쓰인 것이므로 그대로 신뢰하지 말 것.
