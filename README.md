...
정답 계정 세 개가 카드로 떴는지 보면 이렇다.

| 정답 계정 | 카드                          | 어떻게 잡혔나                     |
| --------- | ----------------------------- | --------------------------------- |
| 재고자산  | **떴음** (겹친 관점 2)        | 숫자·추세가 각각 독립으로 지적    |
| 매출원가  | **떴음** (매출↔매출원가↔재고) | 흐름 관점이 세 계정의 괴리로 지적 |
| 자기자본  | 안 뜸                         | 이익잉여금 카드로만 간접 표면화   |

**3개 중 2개.** 자기자본을 놓친 이유는 4.5에서 따로 다룬다.

### 4.4 재고자산 카드가 실제로 무엇을 말했나
...
| 항목               | 실제                                                | 판단                                                                                                   |
| ------------------ | --------------------------------------------------- | ------------------------------------------------------------------------------------------------------ |
| 자기자본 미적중    | 자기자본 카드 없음, 이익잉여금 카드로만 표면화      | 자기자본은 분식의 **결과** 계정이라 원인 계정을 지적하면 별도 카드가 안 선다 — 못 잡은 것으로 남겨둔다 |
...
- 실제 결과: 전체 재작업 및 엔지니어링 병목의 80% 이상이 데이터 파이프라인(적재 및 정제) 구간에 집중됨
