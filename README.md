...
<p align="center">
  <img src="docs/images/ui-flow-1-search.png" width="418" alt="첫 화면 — 회사명을 입력하면 OpenDART 등록회사가 상장사 우선으로 나열된다">
  <img src="docs/images/ui-flow-2-prepare.png" width="418" alt="회사 선택 화면 — raw 보유 연도, 준비완료 연도, 분석 사업연도 선택, LLM 전처리, 멀티 에이전트 교차검증 실행 버튼">
</p>
<p align="center"><sub>① 회사명 검색 — 상장사가 위로, 종목코드·비상장 태그 표시 　·　 ② 연도 선택과 실행 — 보유·준비완료 연도를 보여주고 전처리와 교차검증을 각각 실행</sub></p>

<p align="center"><img src="docs/images/ui-flow-3-queue.png" width="860" alt="검토 큐 — 손익·수익성, 재무상태, 현금흐름 영역별 계정 카드와 계정 관계 이상 카드 목록"></p>
<p align="center"><sub>③ 검토 큐 — 재무제표 영역별로 계정 카드가, 아래에 계정 관계 카드가 쌓인다</sub></p>
...
<p align="center"><sub>④ 카드 한 장 — 결론과 근거 수치, 추이 차트, 반대 가능성·확인 질문·다음 절차가 한 화면에</sub></p>
